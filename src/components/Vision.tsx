          ...
          <div className="p-4">
            ...
            <div className="space-y-6 text-lg">
              <p className="text-velatrix-gray2">
                We are building infrastructure for the next era of digital content. Tools for creators to truly own their work, define their revenue models, and connect directly with audiences in an ecosystem where governance, economic freedom, and market dynamics transparently shape content quality and value distribution
              </p>
