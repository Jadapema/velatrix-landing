      ...
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        {isMobile ? (
            ...
            {isOpen && (
              <div className="absolute top-16 left-0 right-0 bg-velatrix-dark/95 backdrop-blur-lg shadow-lg border-t border-velatrix-blue/20 py-4">
                <div className="flex flex-col space-y-4 px-6">
                  <a href="#products" onClick={toggleMenu} className="text-foreground hover:text-velatrix-blue transition-colors">Products</a>
                  <a href="#vision" onClick={toggleMenu} className="text-foreground hover:text-velatrix-blue transition-colors">Vision</a>
                  <a href="https://watchit.movie" target="_blank" rel="noreferrer" onClick={toggleMenu} className="text-foreground hover:text-velatrix-blue transition-colors">Platform</a>
          ...
          <div className="flex items-center space-x-8">
            <a href="#products" className="text-foreground hover:text-velatrix-blue transition-colors">Products</a>
            <a href="#vision" className="text-foreground hover:text-velatrix-blue transition-colors">Vision</a>
